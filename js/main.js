...
for (var i = 0; i < work.length; i++) {
  content = '<section class="offset0"><a href="pages?webpage='+i+'" title="#" alt="#"><div  class="imgHero" style="background-image: url('+work[i].img+')"></div><h2 class="imgTitle">'+work[i].title+'</h2></a></section>';
...
var block = document.getElementById('block')
    ...
    if (window.location.href.indexOf('pages') !== -1) {
        next.addEventListener('click', function(event) {
            ...
            c++;
            this.setAttribute('href', 'pages?webpage=' + c)
